...
6. Under the **Toolset** section, click on the **Add tool** button. 
    
    ![image](./imgs/lab3/lab3-5.png)

7. Click on **Add from file or MCP Server**.
...
11. You should see the following under **Tools**.
...
13. Since this agent will be a collaborator agent and will be invoked by GFM Bank Orchestrator Agent, we don't want to enable it for direct chat on the chat homepage. Scroll down to **Channels** section and disable the **Home page** feature.
...
## Add Backoffice Agent to Teller Agent

1. Click on **Agent Builder** and **click** your previously created ```[Your_Initial]_GFM_Teller``` Agent.
...
4. Select ```[Your_Initial]_GFM_Backoffice``` and then the **Add to Agent button**.
    
    ![image](./imgs/lab3/lab3-25.png)

5. You should see the following under **Agents**
...
3. Select the following agents and then click the **Add to Agent button**:
  - `[Your initials]_GFM_Teller`
  - `[Your initials]_GFM_Product_Information`
  
    ![image](./imgs/lab3/lab3-461.png)

4. You should see the following under **Agents**
...
## Deploy and test the GFM Bank Orchestrator Agent
1. Click on **Deploy** to deploy the agent
...
3. Click on the hamburger icon on the top left corner of **watsonx Orchestrate** window, and select **Chat**. On the top right, select your Agent called ```[Your_Initial]_GFM_Bank_Orchestrator```.
...
**Congratulations! You’ve built your first Multi-Agent Orchestrator Agent! Thank you for completing the labs!**